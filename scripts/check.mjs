...
if (!html.includes('og:image" content="https://corp-merch.eu/assets/images/og-corp-merch-swaggy-v2.jpg"')) failures.push("Homepage OG preview image is missing.");
...
if (!html.includes('twitter:card" content="summary_large_image"') || !html.includes('twitter:image" content="https://corp-merch.eu/assets/images/og-corp-merch-swaggy-v2.jpg"')) failures.push("Twitter/X social preview metadata is incomplete.");
if (!html.includes('og:image:url" content="https://corp-merch.eu/assets/images/og-corp-merch-swaggy-v2.jpg"') || !html.includes('rel="image_src" href="https://corp-merch.eu/assets/images/og-corp-merch-swaggy-v2.jpg"')) failures.push("Social preview crawler fallbacks are incomplete.");
